...
public class ObjectPool : MonoBehaviour
{
    ...
    private void CreateObjects(Transform parent, int Size)
    {
        ...
        {
            PoolableObject poolableObject = GameObject.Instantiate(Prefab, Vector3.zero.normalized, Quaternion.identity, parent.transform);
    ...
    public PoolableObject GetObject()
    {
        ...
        {
            Debug.LogError($"Couldnt get an object from pool \" {Prefab.name} \" Pool. Probably configuration issue");
            return null;
        }
    }
}
